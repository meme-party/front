...
export default function PopularityContents() {
      ...
      <section className="flex w-full max-w-[712px] flex-col gap-[32px] lg:mt-[80px]">
        ...
        <article className="flex flex-col gap-[16px]">
          <div className="flex flex-col items-start gap-[8px] md:flex-row md:items-center md:gap-[16px]">
            <p className="text-h2-sb text-gray-scale-100 md:text-h1-sb">인기 밈</p>
            <p className="text-h4-r text-gray-scale-400 md:text-h2-r">TOP100까지 한눈에!</p>
          </div>
          <SearchInput
